...
<body style="background: rgb(11,29,38);
             background: linear-gradient(91deg, rgba(11,29,38,1) 0%, rgba(11,29,38,1) 21%, rgba(11,29,38,1) 39%, rgba(11, 29, 38, 0.842) 58%, rgba(139, 100, 62, 0) 100%),
             url('{{ asset('Img/wallpaperEmpresas.jpg') }}');
