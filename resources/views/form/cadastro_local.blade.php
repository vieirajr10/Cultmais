...
@section('conteudo')
    ...
    <div class="box ">
        ...
        <form id="form "action="{{ route('local.store') }}" method="POST" style='width: 100vh; padding: 30px; border-radius:3%; color:aliceblue' enctype="multipart/form-data" onsubmit="return validarFormulario()">

            @csrf

            <h1 style='color:rgb(216, 215, 214); font-size: 27px;'> <br> Cadastro de Local</h1> <br>

            <div class="form-row">
              <div class="form-group col-md-6">
                  <label for="inputNome4">Nome</label>
                  <input type="text" class="form-control require" id="inputNome4" name="nome" placeholder="Nome" oninput="nameValidate()">
                  <span class="span-required">O nome deve ter no mínimo 3 caracteres</span>
              </div>
              <div class="form-group col-md-6">
                  <label for="inputDescricao4">Descriçao</label>
                  <input type="text" class="form-control require" id="inputDescricao4" maxlength="150" name="descricao" placeholder="Descrição simples do local">
                  <span class="span-required">A descrição deve ter no mínimo 10 caracteres</span>
              </div>
          </div> <br>
          ...
          <div class="form-row">
              <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control require" id="inputRua" name="rua" placeholder="ex: Rua José Miguel Navarro">
              </div>
              <div class="form-group col-md-6">
                  <label for="inputBairro">Bairro</label>
                  <input type="text" class="form-control require" id="inputBairro" name="bairro" placeholder="ex: Parque das Amoras I">
              </div>
          </div>
          ...
          <div class="form-row">
              <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control require" id="inputCep" name="cep" placeholder="00000-000">
              ...
              <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control require" id="inputCidade" name="cidade" placeholder="ex: Campinas">
              </div>
              <div class="form-group col-md-1">
                  <label for="inputEstado">Estado</label>
                  <input type="text" class="form-control require" id="inputEstado" name="estado" placeholder="UF">
              </div>
          </div>
